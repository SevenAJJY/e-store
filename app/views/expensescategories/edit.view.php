        ...
        <div class="col-md-12 d-flex align-items-center justify-content-center">
            <div class="my-container">
                ...
                <form action="" class="appform" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="input-box">
                        <input type="text" spellcheck="false" name="ExpenseName" maxlength="30" value="<?= $this->showValue('ExpenseName',$expensescategories) ?>" required>
                        <label for=""><?= $text_ExpenseName ?></label>
                    </div>
                    <div class="input-box">
                        <input type="number" spellcheck="false" name="FixedPayment" min="1" step="0.01" value="<?= $this->showValue('FixedPayment',$expensescategories) ?>" required />
