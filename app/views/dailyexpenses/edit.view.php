        ...
        <div class="col-md-12 d-flex align-items-center justify-content-center">
            <div class="my-container">
                ...
                <form action="" class="appform" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <select class="form-select select-box" name="CategoryId"  >
                            ...
                            <?php if (false !== $categories): ?>
                                <?php foreach ($categories as $category):?>
                                    <option value="<?= $category->ExpenseId ?>" <?= $this->seletedIf('ExpenseId' , $list->ExpenseId , $list); ?> > <?= $category->ExpenseName ?></option>
                                <?php endforeach;?>
                            <?php endif;?>
                        </select>
                    </div>
                    ...
                    <div class="input-box w-notes">
                        <input type="number" spellcheck="false" name="Payment" min="1" step="0.01" value="<?= $this->showValue('Payment', $list) ?>" />
                    ...
                    <div class="input-box">
                        <input type="text" spellcheck="false" name="Description" maxlength="50" value="<?= $this->showValue('Description', $list) ?>" required>
