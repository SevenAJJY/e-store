        ...
        <div class="col-md-12 d-flex align-items-center justify-content-center">
            <div class="my-container">
                ...
                <form action="" class="appform" method="post" autocomplete="off" enctype="application/x-www-form-urlencoded">
                    <div class="input-box">
                        <input type="text" spellcheck="false" name="GroupName" maxlength="20" value="<?php  echo isset($group) ? $group->GroupName : ''; ?>" required>
                        ...
                        <?php if($privileges != false): ?>
                            <?php foreach ($privileges as $privilege): ?>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="Privileges[]" <?php echo in_array($privilege->PrivilegeId , $groupPrivileges) ? 'checked' : '';  ?> value="<?php echo $privilege->PrivilegeId ; ?>" role="switch" id="flexSwitchCheckDefault">
